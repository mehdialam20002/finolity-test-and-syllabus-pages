  ...
  return (
    <footer >
        ...
        <div className='left box'>
            <div className='left-box-content'>
                ...
                <div className='ap-logo-img'>
                    <img src='https://github.com/mehdialam20002/finoalgoskill/blob/master/src/components/images/appstoreLogo.png?raw=true' alt="Apple_store" width="80px" />
     ...
     <div className='footer-end'>
        <div style={{color:"gray"}}> © 2023 Sorting Hat Technologies Pvt Ltd</div>
        <div className='logos'>
        <AiFillFacebook/>
        <AiOutlineYoutube/>
        <AiFillTwitterCircle/>
